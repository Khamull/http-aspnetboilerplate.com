...
{
    public abstract class sampleTestBase : AbpIntegratedTestBase
    {
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<sampleDataModule>();
        }

        public void UsingDbContext(Action<sampleDbContext> action)
        {
        ...
        public T UsingDbContext<T>(Func<sampleDbContext, T> func)
        {
            T result;
